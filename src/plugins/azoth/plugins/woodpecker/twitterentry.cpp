...
namespace Woodpecker 
{
	...
	void TwitterEntry::HandleMessage (MessageInfo info)
	{
		...
		auto msg = new TwitterMessage (dir, IMessage::MTChatMessage, this);
	...
	QObject* TwitterEntry::GetParentAccount () const
	{
		return Account_;
	}
	...
	QObject* TwitterEntry::CreateMessage (IMessage::MessageType type, const QString&, const QString& body)
	{
		auto msg = new TwitterMessage (IMessage::DOut, type, this);
		msg->SetBody (body);
		return msg;
	}

	QList<QObject*> TwitterEntry::GetAllMessages () const
	{
